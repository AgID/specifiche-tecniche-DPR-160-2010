...
CREATE TABLE "territorial_scope_user" (
  "k_id" serial4 PRIMARY KEY NOT NULL,
  "fk_territorial_scope" int4 NOT NULL,
  "description" varchar(255) NOT NULL
);
...
CREATE TABLE "user" (
  "k_id" serial4 PRIMARY KEY NOT NULL,
  "fk_territorial_scope_user" int4 NOT NULL,
  "name" varchar(255) NOT NULL,
...
ALTER TABLE "territorial_scope_user" ADD CONSTRAINT "fk_territorial_scope" FOREIGN KEY ("fk_territorial_scope") REFERENCES "territorial_scope" ("k_id");
...
ALTER TABLE "user" ADD CONSTRAINT "fk_territorial_scope_user" FOREIGN KEY ("fk_territorial_scope_user") REFERENCES "territorial_scope_user" ("k_id");
